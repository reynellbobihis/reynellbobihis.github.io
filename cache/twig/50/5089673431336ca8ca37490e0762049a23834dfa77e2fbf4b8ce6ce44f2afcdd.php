...
class __TwigTemplate_2b94e8b6583e4d9eba4805984b08366e6ba2041c792f60b55c876493bb40d37f extends Twig_Template
{
...
($context["field"] ?? null), "type", array()) == "select")) {
            ...
            // line 24
            echo "                                ";
            echo nl2br(twig_escape_filter($this->env, $this->env->getExtension('Grav\Common\Twig\TwigExtension')->stringFunc($this->getAttribute(($context["form"] ?? null), "value", array(0 => $this->getAttribute(($context["field"] ?? null), "name", array())), "method")), "html", null, true));
            echo "
                            ";
        }
        // line 26
        ...
        try {
            ...
            foreach ($context['_seq'] as $context["index"] => $context["field"]) {
                ...
                if (((null === ($context["input"] ?? null)) || (($context["input"] ?? null) == true))) {
                    // line 5
                    echo "            ";
                    if ($this->getAttribute(($context["form"] ?? null), "value", array(0 => $this->getAttribute($context["field"], "name", array())), "method")) {
                        // line 6
                        echo "                ";
...
", "forms/default/data.html.twig", "/storage/ssd4/593/2290593/public_html/user/plugins/form/templates/forms/default/data.html.twig");
    }
}
